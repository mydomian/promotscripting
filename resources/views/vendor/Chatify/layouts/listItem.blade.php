...
<a href="{{ $image }}" download="">
    <div class="shared-photo chat-image col-3" style="color:black; background-image: url('@if($extension == 'png' || $extension == 'jpg' || $extension == 'jpeg' || $extension == 'gif') {{ $image }} @else data:image/png;base64, @endif')">@if($extension == 'txt') txt file @elseif($extension == 'zip') zip file @elseif($extension == 'rar') rar file @endif</div>  
</a>
