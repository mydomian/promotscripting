                    ...
                    <div class="col-md-6">
                        <form action="{{ route('create.acc') }}" method="post">
                            ...
                            <div class="col-md-12 d-flex flex-column text-white mb-3">
                                <h4>Get Paid</h4>
                                <p>
                                    Connect your Bank account with Stripe to start receiving payments from every sale of
                                    your Prompt.
                                </p>

                                <label for="" class="form-label">Country Residence</label>
                                <i class="text-secondary"><small>We need to know this for sending payouts. Please read our
                                        FAQ if your country does not appear here.
