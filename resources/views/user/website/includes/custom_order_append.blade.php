        ...
        <div class="card marketplace--card rounded-3 mt-2">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <a href="javascript:;" class="text-white text-decoration-none fw-semibold" style="padding-left: 10px;"> <small> {{$customOrder->user->name ?? ""}}</small></a>
                    </div>
                    <a
                    href="javascript:;"
                    ...
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRS-dll6pDo9z-1x6-ndg37qiSOv2sERQfA4w&usqp=CAU" alt="" class="img-fluid w-100 rounded-3 object-fit-cover"/>
                    <span class="bg-dark mx-2 mt-2 text-white text-center opacity-50" style="height: 25px;">Custom Order</span>
                    </a>
                    <div class="d-flex justify-content-between">
                        <small class="text-body-tertiary">Order ${{ $customOrder->price }}</small>
                        <small class="text-body-tertiary">Charge ${{ $customOrder->charge_amount }}</small>
                    </div>
