@forelse ($marketPlaces as $marketPlace)
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card marketplace--card rounded-3">
                ...
                <div class="card-body">
                    <a href="{{ route('public.profile',$marketPlace->user->id) }}">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <a href="{{ route('public.profile',$marketPlace->user->id) }}" class="text-white text-decoration-none fw-semibold" style="padding-left: 10px;"> <small> {{ $marketPlace->user ? $marketPlace->user->name : ''  }}</small></a>
                        </div>
                    </a>
                    <a
