        ...
        <div class="card marketplace--card rounded-3">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <a href="" class="text-white text-decoration-none fw-semibold" style="padding-left: 10px;"> <small> {{ $marketPlace->user ? $marketPlace->user->name : ''  }}</small></a>
                </div>
                <a
                href="#"
                ...
                @endphp
                <img src="@if($marketPlace->image) {{ asset('/storage/product/thumbnil/'.$marketPlace->image) }} @else https://picsum.photos/200/300 @endif" alt="{{ $slug }}" class="img-fluid w-100 rounded-3 object-fit-cover"/>
                ...
                <div class="d-flex justify-content-between gap-3">
                    <a href="" class="link-light text-decoration-none">{{ Str::limit($marketPlace->title,22) ?? "" }}</a>
