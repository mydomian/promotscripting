...
@section('content')
    ...
    <main class="flex-shrink-0">
      ...
      <!-- Hero Marketplace -->
        <!-- Hero About -->
        <section class="hero-about page-header bg-body">
          <div class="container">
        ...
        <!-- Konw About Us -->
        <section class="know-about-us section bg-body">
          <div class="container">
              ...
              <div class="card-body">
                <div class="row gy-5 gy-lg-0 gx-lg-5">
                  ...
                  <div class="col-lg-7 align-self-end">
                    <h3 class="h2 fw-bold text-primary">Who we are?</h3>
        ...
        <!-- Our Prompt Stats -->
        <section class="our-prompt-stats section bg-body">
          <div class="container">
            <div class="container">
              <div class="card mb-5">
              ...
              <div class="row justify-content-center text-center ">
                <div class="col-lg-10 col-xl-7">
                  <h2 class="h4 text-primary">Prompt statistics</h2>
                  ...
                  <div class="row g-4">
                    <div class="col-md-6">
                      <div class="card our-prompt-stat--card">
                        <div class="card-body p-4">
                          <h4 class="h2 text-primary mb-2">{{totalProduct()}}</h4>
                          <p class="fs-5 text-white mb-0">Prompts</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="card our-prompt-stat--card">
                        <div class="card-body p-4">
                          <h4 class="h2 text-primary mb-2">{{totalSale()}}</h4>
                    ...
                    <div class="col-md-6">
                      <div class="card our-prompt-stat--card">
                        <div class="card-body p-4">
                          <h4 class="h2 text-primary mb-2">{{ totalUser()}}</h4>
                    ...
                    <div class="col-md-6">
                      <div class="card our-prompt-stat--card">
                        <div class="card-body p-4">
                          <h4 class="h2 text-primary mb-2">{{totalOrder()}}</h4>
                          <p class="fs-5 text-white mb-0">Orders</p>
                        </div>
                      </div>
                    </div>
                  </div>
