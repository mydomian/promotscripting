...
@section('content')
    ...
    <section class="hero-marketplace page-header bg-body">
        ...
        <p class="text-white text-center mb-0">
            Please {{ $setting->email ?? "email" }} or {{ $setting->phone ?? "phone" }} us if you have any queries about the site, advertising, or anything else. <br>
    ...
    <section class="prompt-details custom-offers section text-white bg-dark">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
              <div class="d-grid gap-5">
                ...
                <form class="default-form2" action="{{ route('SaveContactMessage') }}" method="post">
                    @csrf
                    <div>
                    ...
                    <button class="btn btn-outline-primary btn-sm form-control mt-3"  type="submit">Send</button>
                </form>
              </div>
            </div>
          </div>
