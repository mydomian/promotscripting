                    ...
                    <div class="col-sm-12 col-md-6 col-lg-7 col-xl-8">
                        <h3 class="text-white fw-bold mb-4">
                            <span class="fw-bolder">
                                Prompt <span class="text-primary bubble-gradient">Details
                                    </h1>
                                    ...
                                    <form action="{{ route('sell.subcategory') }}" method="post">
                                        ...
                                        <div class="col-md-12 d-flex flex-column text-white mb-3">
                                            ...
                                            <i class="text-secondary"><small>Select the type of prompt you want to
                                                    sell</small></i>
                                            <div class="col-md-12">
                                                <select name="category_id"
                                                    class="form-control mt-2 bg-transparent form-select @error('category_id')is-invalid  @enderror"
                                                    id="">
                                                    <option class="bg-body" value="" selected>Select category</option>
                                                    @forelse ($categories  as $category)
                                                        <option class="bg-body" value="{{ $category->id }}">
                                        ...
                                        <div class="col-md-12 d-flex flex-column text-white mb-3">
                                            ...
                                            <i class="text-secondary"><small>Describe what your prompt does to a potential
                                                    buyer. A more detailed description will increase your sales.</small></i>
                                            <div>
                                                <textarea name="description" id="" cols="10" rows="5"
                                                    class="form-control bg-transparent  @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12 d-flex flex-column text-white mb-3">
                                            ...
                                            <i class="text-secondary"><small class="">What do you think the price of
                                                    this prompt should be?</small></i>
                                            <div class="col-md-12">
                                                <input type="number" name="price"
                                                    class="form-control bg-body @error('price') is-invalid  @enderror" value="{{old('price')}}"
                                                    placeholder="Enter your price" step="any" min="1">
                                                @error('price')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
