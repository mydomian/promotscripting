                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('/storage/blog/' . $blog->image) }}"
                                                    style="width: 60px;height:40px;" alt="blog-image">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @elseif($blog->status == 'inactive')
                                                    <span class="badge bg-warning">{{ $blog->status ?? '' }}</span>
                                                @else
                                                    <span class="badge bg-danger">{{ $blog->status ?? '' }}</span>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        <li><a class="dropdown-item blogActive" href="javascript:;"
                                                                getUrl="{{ route('admin.blogStatus', ['blog' => $blog->id, 'type' => 'active']) }}">Active</a>
                                                        </li>
                                                        <li><a class="dropdown-item blogInactive" href="javascript:;"
                                                                getUrl="{{ route('admin.blogStatus', ['blog' => $blog->id, 'type' => 'inactive']) }}">Inactive</a>
                                                        </li>
                                                        <li><a class="dropdown-item blogBan"
                                                                href="javascript:;"getUrl="{{ route('admin.blogStatus', ['blog' => $blog->id, 'type' => 'ban']) }}">Ban</a>
                                                        </li>
                                                        <li><a class="dropdown-item" href="javascript:;"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#UpdateTeam{{ $blog->id }}">Edit</a>
                                                        </li>
                                                        <li><a class="dropdown-item blogDestroy" href="javascript:;"
                                                                getUrl="{{ route('admin.blogDestroy', ['blog' => $blog->id]) }}">Delete</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
                                                                                        ...
                                                                                        @if (!empty($category['subCategories']))
                                                                                            @foreach ($category['subCategories'] as $subCategory)
                                                                                                <option
                                                                                                    ...
                                                                                                    @if ($subCategory->id == $blog->sub_category_id) selected @endif>
                                                                                                    ➥
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="sub_category_id" class="form-control mt-2" id="sub_category_id"
                                            required>
                                            <option value="">Select Your Subcategory</option>
                                            @if (!empty($categories))
                                                @foreach ($categories as $category)
                                                    <option value="" disabled>{{ $category->category_name }}
                                                    </option>
                                                    @if (!empty($category['subCategories']))
                                                        @foreach ($category['subCategories'] as $subCategory)
                                    ...
                                    <div class="col-md-12 text-end mt-2">
                                        <button class="btn btn-sm btn-dark" type="submit">Save <i
                                                data-feather="save"></i></button>
                                    </div>
                                </div>
                            </div>
