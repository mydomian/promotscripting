    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Contact Us Banner</li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Contact Us Banner</h6>
                        <form method="POST" action="{{ route('admin.updatecontactusbanner') }}" enctype="multipart/form-data">
